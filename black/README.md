...
executarem corretamente a API principal (`black.format_str`).
...
### Testes IA (41)
- 100% concentrados em `test_black_new.py`  
...
- ❌ Evitar replicar cobertura histórica manual via IA  
- ❌ Não substituir suítes maduras por testes automáticos  
